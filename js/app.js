...
/* ====================================================
   РУКОВОДСТВО ПОЛЬЗОВАТЕЛЯ (ВИЗУАЛЬНЫЕ МАКЕТЫ + ПОДРОБНЫЕ ОПИСАНИЯ ДЛЯ ЮЗЕРОВ)
==================================================== */
...
function renderInstructionTabContent(tabKey) {
    ...
    // Общая подсказка про значки вопросов в начале каждого раздела
    const questionMarkTip = `
        <div style="background: rgba(243, 166, 0, 0.08); border: 1.5px solid rgba(243, 166, 0, 0.35); border-radius: 14px; padding: 12px 14px; margin-bottom: 14px; font-size: 12px; line-height: 1.5; color: #cbd5e1;">
            💡 <b>Подсказка:</b> По всему терминалу рядом с названиями разделов и кнопок расставлены круглые значки вопросов <b>[ ? ]</b>. Если вам в любой момент станет непонятно, как рассчитывается тот или иной показатель, просто нажмите на ближайший вопросик — откроется окно с простым объяснением и формулой.
        </div>
    `;

    const sections = {
        // ==========================================
        // РАЗДЕЛ 1: СВОДКА И ИНКОГНИТО
        // ==========================================
        dashboard: `
            ${questionMarkTip}
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Главный аналитический экран терминала. Здесь в режиме реального времени отображаются ваши финансовые результаты по всем картам и биржевым счетам.
            </p>
...
+4 500.00 ₽ + 35.50 USDT           ≈ +7 820.00 ₽ (Мид Прайс)
                                   ≈ +83.70 USDT (Конвертация)
💡 Раздельный профит в фиате и USDT. Справа — общий эквивалент.
📈 +14.2% к прошлому периоду
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Нажав на иконку глаза в верхнем углу, вы мгновенно размываете все суммы, балансы карт и цифры прибыли эффектом матового стекла. Это защищает ваши данные в общественных местах, не меняя при этом размеры кнопок и интерфейса.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">2. Временные периоды (Таймфреймы)</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Переключайте аналитику кнопками «За сегодня», «За месяц» или «Все время». Если нужно посмотреть конкретный отрезок, откройте «Свой период» и выберите даты вручную или через пресеты («Вчера», «7 дней», «30 дней»).
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">3. Как читать общую прибыль</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Чистый доход разделен на две независимые части со своими знаками и цветами: отдельно показываются заработанные рубли на картах и отдельно чистый прирост криптовалюты USDT. Справа выводятся желтый (фиатный эквивалент) и синий (USDT эквивалент) общие итоги по курсу Mid Price.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 6px 0;">4. Создание PnL-отчета (📸 PnL)</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Кнопка PnL формирует красивую картинку с вашими результатами за выбранный период. Нажав «Отправить в бот», вы мгновенно получаете этот готовый отчет в личные сообщения Telegram.
            </p>
        `,

        // ==========================================
        // РАЗДЕЛ 2: КАЛЬКУЛЯТОР КРУГА
        // ==========================================
        calc: `
            ${questionMarkTip}
            <div style="font-size: 15px; font-weight: 900; color: var(--bybit-yellow); margin-bottom: 8px;">
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Инструмент для предварительного расчета маржинальности арбитражного круга перед тем, как вы начнете проводить ордера на бирже.
            </p>

            <div class="inst-ascii-card">
⚡️ КАЛЬКУЛЯТОР КРУГА                                           [ ? ]
─────────────────────────────────────────────────────────────────
Привязать карту: [ 💳 Т-Банк 1 (Касса: 154 000 ₽)               ▼ ]
Прайс сделки (Сумма закупки): [ 100000                        ]
Тип фиксации прибыли: [ 💰 Прибыль в фиате ]  [ 🪙 Прибыль в USDT ]
─────────────────────────────────────────────────────────────────
[ ПОКУПКА 🟢 (90.20 ₽) ]        │ [ ПРОДАЖА 🔴 (92.80 ₽) ]
 Получено: 1 108.65 USDT        │  Продано: 1 108.65 USDT
─────────────────────────────────────────────────────────────────
Спред: +2.88%
Прибыль с круга: 0.00 USDT (≈ +2 882.48 ₽)
[ Сохранить круг ✅ ]                          [ Очистить ❌ ]
            </div>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">1. Привязка карты и прайс сделки</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Выберите карту, с которой проводите связку. При сохранении круга сумма закупки автоматически спишется с кассы этого счета, а оборот запишется в лимит 115-ФЗ. В поле прайса введите сумму рублей для закупки крипты.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">2. Два режима фиксации прибыли</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                • <b>Прибыль в фиате:</b> вы полностью распродаете купленные монеты, возвращая исходный депозит и заработанный спред на карту в рублях.<br>
                • <b>Прибыль в USDT:</b> вы продаете только часть монет для возврата рублевого депозита, а всю чистую прибыль оставляете на бирже в криптодолларах.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 6px 0;">3. Сохранение в историю</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Кнопка «Сохранить круг» записывает сделку в облачную историю под звуковое сопровождение звенящих золотых монет.
            </p>
        `,
        ...
        calendar: `
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Ваш личный финансовый календарь. Каждый день месяца подсвечивается определенным цветом в зависимости от вашей торговой доходности.
            </p>
...
[ ‹ ]                    СЕНТЯБРЬ 2026                          [ › ]
  ...
  31     1     2     3     4     5     6  [ Зеленый — плюс ]
 [  ]  [🟢]  [🟢]  [🟢]  [🟢]  [🟢]  [🟢]  [ Красный — минус ]
  7      8     9    10    11    12    13  [ 🔥 — заблокирован ]
 [🟢]  [🟢]  [🔴]  [🟢]  [🟢]  [🟢]  [🟢]
            </div>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">1. Цветовые уровни дней</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                • <b>Изумрудный:</b> сверхприбыльный день (более 10 000 ₽).<br>
                • <b>Насыщенный зеленый:</b> отличный плюс (от 2 000 до 10 000 ₽).<br>
                • <b>Приглушенный зеленый:</b> небольшой плюс (до 2 000 ₽).<br>
                • <b>Красный:</b> день закрылся в минус.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">2. Зажатие пальца и сводка дня</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Зажмите палец на любом дне календаря, и над ним появится всплывающая подсказка с точной суммой и спредом. Клик по ячейке открывает детальное окно аудита всех сделок за эти сутки.
            </p>
        `,
        ...
        trade: `
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Раздел для внесения разовых ордеров покупки или продажи, если вы торгуете по раздельной схеме (покупаете у одного мерчанта, а распродаете частями).
            </p>

            <div class="inst-ascii-card">
Новая операция
[ ПОКУПКА 🟢 ]                     [ ПРОДАЖА 🔴 ]
[ Сумма фиата (₽) ]                [ Объем USDT (🪙) ]
Сумма в фиате: [ 50000.00       ]
Курс USDT:     [ 90.50          ]
Карта:         [ 💳 Т-Банк 2   ▼]
Расчетный USDT: 552.49 USDT
[ СОХРАНИТЬ ПОКУПКУ: 50000.00 ₽ ]
            </div>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">1. Покупка 🟢 против Продажи 🔴</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                • <b>Покупка:</b> тратите рубли с карты, уменьшаете суточный лимит 115-ФЗ, пополняете склад крипты.<br>
                • <b>Продажа:</b> отдаете криптовалюту, принимаете рубли на карту (лимит 115-ФЗ при этом не расходуется).
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">2. Способ указания суммы</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Указывайте сумму в рублях (терминал сам пересчитает монеты) или вводите точный объем USDT из биржевого ордера.
            </p>
        `,

        // ==========================================
        // РАЗДЕЛ 5: КАРТЫ (ПОДРОБНО СО ВСЕМИ ВКЛАДКАМИ ШТОРКИ)
        // ==========================================
        cards: `
            ${questionMarkTip}
            <div style="font-size: 15px; font-weight: 900; color: var(--bybit-yellow); margin-bottom: 8px;">
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Главный защитный модуль терминала. Помогает следить за остатками на счетах, контролировать лимиты банков по 115-ФЗ и вовремя отправлять карты на «отлежку».
            </p>
...
─────────────────────────────────────────────────────────────────
▌ Т-Банк 1 (Дроп Алексей) 📌                [ 184 200.00 ₽ ]
▌ 🟢 В работе                                  🟢 14 / 🔴 9
▌ 💬 Сим-карта в модеме, лимит СБП 100к
...
Месячный лимит:   420 000 / 1 000 000 ₽ (42%) [██████░░░░░░░░]
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Под каждой картой отображаются две полоски (суточная и месячная). Они заполняются при закупках крипты и при снятии наличных с включенной галочкой учета лимита. При достижении 90% полоска становится красной. Ровно в 00:00:00 суточный лимит сбрасывается в ноль.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 14px 0 4px 0;">2. Статусы карт</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                • <b>🟢 В работе:</b> карта активна.<br>
                • <b>⏳ На отлежке:</b> карта на паузе. Вы задаете таймер в часах, карта ведет обратный отсчет (например: <i>⏳ До 15 сен, 14:00</i>) и по истечении времени сама возвращается в работу под звон монет.<br>
                • <b>🔥 115-ФЗ:</b> карта заблокирована банком, уходит в архив в самый низ списка и становится полупрозрачной.<br>
                • <b>⛔️ Лимит исчерпан:</b> система ставит этот статус автоматически при исчерпании 100% лимита.
            </p>

            <div style="font-size: 14px; font-weight: 900; color: var(--bybit-yellow); margin: 18px 0 6px 0;">3. Шторка карты (Все 4 вкладки управления)</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 10px 0;">
                Клик по любой карте открывает шторку с четырьмя вкладками:
            </p>

            <div style="font-size: 12.5px; font-weight: 800; color: #fff; margin: 8px 0 2px 0;">Вкладка 1: «📊 Сводка»</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Показывает текущий остаток кассы, быстрый селектор смены статуса, кнопки быстрого ввода наличности («➕ Внести в кассу» и «➖ Снять наличные»), 4 аналитические плитки кассы (закуплено, принято, пополнено, снято) и две кнопки быстрого копирования: шаблон чата и чистый номер карты без пробелов.
            </p>

            <div style="font-size: 12.5px; font-weight: 800; color: #fff; margin: 8px 0 2px 0;">Вкладка 2: «💸 Касса»</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Журнал физических операций с наличными по счету. Каждая запись содержит дату, сумму, комментарий и отметку учета в лимите. Записи можно редактировать (✏️) или удалять (🗑) с пересчетом баланса.
            </p>

            <div style="font-size: 12.5px; font-weight: 800; color: #fff; margin: 8px 0 2px 0;">Вкладка 3: «⚙️ Настройки»</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Здесь можно изменить название банка, номер карты, ФИО получателя, суточный и месячный лимиты (0 = безлимит ∞), задать время отлежки, выбрать цветной маркер банка, добавить заметку, а также закрепить карту (📌), клонировать ее (📑), сделать трансфер или удалить.
            </p>

            <div style="font-size: 12.5px; font-weight: 800; color: #fff; margin: 8px 0 2px 0;">Вкладка 4: «📜 Сделки»</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Хронологический список всех ордеров и связок, которые были привязаны именно к этой карте.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 14px 0 4px 0;">4. Межкассовый трансфер (🔄 Трансфер)</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Перевод фиата между своими счетами. Трансфер не влияет на торговую прибыль, не расходует суточный лимит 115-ФЗ и автоматически создает парные записи в кассе обеих карт.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 14px 0 4px 0;">5. Шаблоны реквизитов для чата биржи</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Настройте единый шаблон сообщения с тегами <code>{bank}</code>, <code>{number}</code>, <code>{holder}</code>. Клик по кнопке «Шаблон чата ордера» в шторке подставит реальные реквизиты карты и скопирует текст для вставки в P2P-чат биржи.
            </p>
        `,
        ...
        history: `
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Облачный журнал всех ваших закрытых ордеров и связок с инструментами управления и повтора.
            </p>
...
📝 Закупка мейкером через Т-Банк, продажа тейкером
                                           [ 🔁 ]  [ ✏️ ]  [ 🗑 ]
            </div>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">1. Кнопка быстрого повтора (🔁)</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Нажав на значок 🔁 возле любой прошлой сделки, вы мгновенно копируете ее сумму, курсы и привязанную карту обратно в калькулятор, чтобы запустить точно такой же круг в один клик.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 12px 0 4px 0;">2. Цветные метки и очистка</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Сделки можно подсвечивать цветными метками для группировки по биржам. А кнопка очистки позволяет безопасно удалить старые операции за день, месяц или всю базу целиком.
            </p>
        `,
        ...
        profile: `
            ...
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Панель персонализации интерфейса под ваше устройство, выбор языка, валюты и реферальная программа.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 10px 0 4px 0;">1. Визуальные эффекты (FX) и звук кассы</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 8px 0;">
                Переключайтесь между полным FX-режимом (3D-сферы и неоновые переливы) и строгим OLED-черным минимализмом для экономии батареи смартфона. Здесь же включается аудиозвук звона монет при сохранении ордеров.
            </p>

            <div style="font-size: 13px; font-weight: 800; color: #fff; margin: 14px 0 4px 0;">2. Партнерская сеть</div>
            <p style="font-size: 12px; line-height: 1.6; color: #cbd5e1; margin: 0 0 12px 0;">
                Приглашайте других трейдеров по вашей персональной ссылке. За каждого пользователя, который активирует пробный период, терминал автоматически начислит вам <b>+3 дня Premium</b> доступа.
            </p>
        `
    };
